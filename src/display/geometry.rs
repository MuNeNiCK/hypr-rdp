...
mod tests {
    ...
    #[test]
    fn aspect_fit_adds_horizontal_letterbox_bars_as_fallback() {
    ...
    #[test]
    fn aspect_fit_adds_vertical_pillarbox_bars_as_fallback() {
    ...
    #[test]
    fn presentation_points_in_fallback_bars_clamp_to_source_edges() {
